                                ...
                                <el-card :body-style="{ padding: '0px' }">
                                    <div slot="header" class="header">
                                        ...
                                        <div style="display: inline;">
                                            <el-button v-if="item.state != null && item.state===0" type="primary"
                                                       disabled size="mini"
                                                       round>正常
                                            </el-button>
                                            <el-button v-else-if="item.state != null && item.state===1"
                                                       type="danger" disabled size="mini"
                                                       round>用户删除
                                            </el-button>
                                            <el-button v-else-if="item.state != null && item.state===2"
                                                       type="danger" disabled size="mini"
                                                       round>管理员删除（都不可见）
                                            </el-button>
                                            <el-button v-else-if="item.state != null && item.state===3"
                                                       type="danger" disabled size="mini"
                                                       round>管理员删除（单用户可见）
                                            </el-button>
                                            <el-button v-else type="warning" disabled plain size="mini" round>待审核
                                            </el-button>
                                        </div>
                                    </div>
                                    <div class="body" @click="details(item.id)">
                                        ...
                                        <div class="content" v-if="item.content != null && item.content != ''">
                                            {{item.content}}
                                        </div>
                                        <div style="padding: 5%;">
                                            ...
                                            <el-dropdown
                                                style="vertical-align: middle; cursor: pointer;padding-left: 6px;">
                                                  <span class="el-dropdown-link">
                                                      <i class="el-icon-more el-icon--right"></i>
                                                  </span>
                                                <el-dropdown-menu slot="dropdown" style="padding-left: 0">
                                                    <el-dropdown-item @click.native="batchLike(item.id)">批量点赞
                                                    </el-dropdown-item>
                                                </el-dropdown-menu>
                                            </el-dropdown>
                                            <span
                                                style="margin-right: 5%;display: inline;">C币：{{item.obtainCb}}</span>
